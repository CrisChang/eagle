package com.poison.paycenter.ext.apple;
...
public class ApplePayQuery {
	...
	public static String buyAppVerify(String receipt) {
		// "environment" = "Sandbox";
		// String url = getVerifyURL();
		String url = url_verify;
		String verifyState = getEnvironment(receipt);
	...
	public static String getEnvironment(String receipt) {
		if(receipt!=null && receipt.indexOf("\"environment\"")>-1){
			if(receipt.indexOf("\"Sandbox\"")>-1){
				return "Sandbox";
			}
		}
		return "Real";
