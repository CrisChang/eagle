...
/**
 * 
 * 类的作用:此类的作用是处理业务相关的数据
 * 作者:闫前刚
 * 创建时间:2014-7-31上午10:49:02
...
public interface DiaryService {
	 ...
	 * <p>Description: 根据用户的ID查询日记详情</p> 
	 * @author :changjiang
	 * date 2014-8-2 下午3:50:20
	 * @param userIdList
	 * @param resId
	 * @return
	 */
	 ...
	 * <p>Description: 查询日志的总数</p> 
	 * @author :changjiang
	 * date 2014-12-9 下午7:07:28
	 * @param userId
	 * @return
	 */
	 ...
	 * <p>Description: 根据用户id查询日志列表</p> 
	 * @author :changjiang
	 * date 2015-6-5 下午3:31:09
	 * @param userId
	 * @param resId
	 * @return
	 */
